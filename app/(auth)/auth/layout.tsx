...
export default function AuthLayout({
  ...
  return (
    <div className="h-dvh overflow-hidden bg-muted/30 grid grid-cols-3">
      {/* Left Hero Panel */}
      <div className="relative col-span-1 hidden w-[440px] shrink-0 overflow-hidden rounded-2xl m-3 lg:block">
        {/* Background Image */}
        ...
        <div className="relative z-10 flex h-full justify-between flex-col p-6">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-white/80">
              ...
              surveying and modern AI-powered automation. Whether you work alone
              or with a team, unlock precision, speed, and compliance—all in one
              platform.
            </p>
          </div>
      ...
      {/* Right Content Panel */}
      <div className="col-span-2 flex flex-1 items-center justify-center p-4 lg:p-6">
