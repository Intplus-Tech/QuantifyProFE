...
export function LibrariesSidebar({ basePath, categories }: LibrariesSidebarProps) {
  ...
  return (
    <Card className="w-full md:w-64 shrink-0 p-4 shadow-sm border-border/50 bg-card">
        ...
        {categories.map((cat) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center justify-between px-3 py-2.5 rounded-lg text-sm transition-colors ${isActive
