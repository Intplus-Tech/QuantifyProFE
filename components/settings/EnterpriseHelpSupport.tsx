    ...
    <div className="space-y-6">
            ...
            <CardContent className="p-8 text-center space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Search our knowledge base for quick answers to common
                  questions.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-2">
                {categories.map((cat, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col items-center gap-2 p-5 rounded-xl border border-border/30 hover:border-orange-200 hover:bg-orange-50/30 transition-colors cursor-pointer"
                  >
                    <div
      ...
      <Card className="shadow-sm border-border/50">
        <CardHeader className="flex flex-row items-center justify-between pb-4">
          ...
          <button className="text-sm font-semibold text-orange-500 hover:text-orange-600 uppercase tracking-wider text-[10px]">
            VIEW ALL
          </button>
        </CardHeader>
