        ...
        <CardContent className="space-y-5">
          <div className="flex items-center justify-between bg-slate-50 rounded-xl p-5 border border-border/30">
            <div>
              ...
              {billingInfo && billingInfo.plan && (
                <p className="text-muted-foreground text-sm">
                  ₦{billingInfo.plan.monthlyPrice.toLocaleString()}/
                  {billingInfo.billingInterval === "monthly" ? "month" : "year"}{" "}
                  · Renews{" "}
            ...
            <div className="flex gap-2">
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button
                    ...
                    className="border-red-200 text-red-500 hover:bg-red-50 font-medium h-10"
                  >
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action will cancel your current subscription. You will still have
                      access to your plan until the end of the current billing period.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
              ...
              <Button
                size="sm"
                className="bg-primary hover:bg-primary/80 text-white font-medium h-10"
